#!/usr/bin/env node
/**
 * scripts/seedNooshazinPanels.mjs — یک‌بار-اجراست، نه بخشی از اپ.
 *
 * ── چرا این اسکریپت به‌جایِ ساختنِ دستیِ ۲۰ پنل ──────────────────────────
 * کاربر متنِ کاملِ نقشه‌یِ باتِ «نوش‌آذین» (یک باتِ نمایشگاهی: صفحه‌یِ شروع،
 ...
 * صفحه‌ی ۶ی متنِ اصلیِ کاربر یک دکمه‌ی «📞 تماس با نوش‌آذین → لینکِ شماره
 ...
 * ولی این اسکریپت شماره/لینکِ *واقعیِ* نوش‌آذین را ندارد — پایین همین فایل
 * (NOOSHAZIN_PHONE_PLACEHOLDER/NOOSHAZIN_WHATSAPP_PLACEHOLDER) دو placeholder
 ...
 *
 * ── نحوه‌ی اجرا ──────────────────────────────────────────────────────────
 *   1. از سایتِ واقعیِ IRFORGE با اکانتِ صاحبِ باتِ نوش‌آذین لاگین کن.
 ...
 *   4. NOOSHAZIN_PHONE_PLACEHOLDER و NOOSHAZIN_WHATSAPP_PLACEHOLDER پایین را با
 *      مقدارِ واقعی عوض کن.
 *   5. اجرا:
 *        IRFORGE_BASE_URL=https://your-real-domain \
 *        IRFORGE_TOKEN=<your bearer token> \
 *        IRFORGE_BOT_ID=<your bot id> \
 *        node scripts/seedNooshazinPanels.mjs
...
// ── placeholderهایِ شماره‌تماس/لینکِ پیامِ واقعیِ نوش‌آذین — قبل از اجرا عوض کنید ──
const NOOSHAZIN_PHONE_PLACEHOLDER = "+98912xxxxxxx";
const NOOSHAZIN_WHATSAPP_PLACEHOLDER = "https://wa.me/98912xxxxxxx";
...
const PANELS = [
  {
    ...
    isHome: true,
    content:
      "🌿 به نوش‌آذین خوش آمدید\n\nنوش‌آذین فضایی خصوصی در دل طبیعت است؛\nجایی برای ساختن تجربه‌هایی متفاوت برای مناسبت‌های خاص.\n\nاینجا می‌توانید با فضای نوش‌آذین، نمونه تجربه‌ها و امکانات آن آشنا شوید.",
    buttons: [
      { label: "🎬 نوش‌آذین را ببینید", target: "video" },
      { label: "✨ تجربه‌های نوش‌آذین", target: "experiences" },
      { label: "🎨 امکانات نوش‌آذین", target: "amenities" },
      { label: "📸 گالری", target: "gallery" },
      { label: "📞 تماس با نوش‌آذین", target: "contact" },
    ],
  },
  {
    key: "video",
    title: "🎬 نوش‌آذین را ببینید",
    content:
      "(ویدئوی معرفیِ ۳۵ ثانیه‌ایِ نوش‌آذین را از همین پنل، تبِ «رسانه»، آپلود کنید — تلگرام فقط با فایلِ واقعاً آپلودشده کار می‌کند.)\n\nنوش‌آذین را می‌توان برای مناسبت‌های مختلف، متناسب با نوع برنامه و سلیقه شما آماده کرد.",
    buttons: [
      { label: "✨ تجربه‌های نوش‌آذین", target: "experiences" },
      { label: "🎨 امکانات نوش‌آذین", target: "amenities" },
  ...
  {
    key: "experiences",
    title: "✨ تجربه‌های نوش‌آذین",
    content: "در نوش‌آذین می‌توان تجربه‌های مختلفی طراحی کرد؛ از یک دورهمی ساده تا یک مناسبت کاملاً اختصاصی.",
    buttons: [
  ...
  },
  {
    ...
    title: "🎁 سورپرایز",
    content:
      "گاهی مهم‌ترین قسمت یک مناسبت، لحظه‌ای است که قرار است اتفاق بیفتد.\n\nدر نوش‌آذین می‌توان مسیر ورود، فضا، موسیقی، گل، شمع، کیک و جزئیات دیگر را برای ساختن یک سورپرایز متفاوت هماهنگ کرد.",
    buttons: [
      { label: "📸 دیدن نمونه‌ها", target: "gallery" },
      { label: "🎨 امکانات", target: "amenities" },
      { label: "📞 صحبت با نوش‌آذین", target: "contact" },
      { label: "⬅️ بازگشت", target: "experiences" },
    ],
  },
  {
  ...
  },
  {
    ...
    content: "یکی از ویژگی‌های اصلی نوش‌آذین، ترکیب فضای کافه با باغ، گلخانه و طبیعت است.\n\nاین فضاها بسته به نوع برنامه می‌توانند بخشی از تجربه شما باشند.",
    buttons: [
      { label: "📸 دیدن فضا", target: "gallery" },
      { label: "📞 اطلاعات بیشتر", target: "contact" },
    ],
  ...
  },
  {
    ...
    title: "📸 گالری",
    content:
      "📸 نوش‌آذین را در تصاویر ببینید\n\n" +
      "🌿 فضای نوش‌آذین — عکس‌های باغ، گلخانه و کافه\n" +
  ...
  },
  {
    ...
    content:
      ...
      `📞 تماس مستقیم: ${NOOSHAZIN_PHONE_PLACEHOLDER}`,
    buttons: [
      { label: "💬 پیام به نوش‌آذین", url: NOOSHAZIN_WHATSAPP_PLACEHOLDER },
      { label: "🏠 صفحه اصلی", target: "home" },
    ],
  },
];
...
async function main() {
  ...
  console.log(
    "باقی‌مانده برایِ شما: (۱) ویدئوی صفحه‌ی «نوش‌آذین را ببینید» و تصاویرِ گالری را از پنلِ وب آپلود کنید، " +
    "(۲) NOOSHAZIN_PHONE_PLACEHOLDER/NOOSHAZIN_WHATSAPP_PLACEHOLDER را — اگر قبل از اجرا عوض نکرده‌اید — از صفحه‌ی «تماس» ویرایش کنید.",
  );
}
